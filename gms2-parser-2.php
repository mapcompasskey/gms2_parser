...
<body>
    ...
    <div class="page-navigation">
        <div class="page-navigation-inner">
            ...
            <?php if ($gms2_parser->navigation_scripts_content) : ?>
                <div class="resource-tree">
                    <?php echo $gms2_parser->navigation_scripts_content; ?>
                </div>
            <?php endif; ?>
            
            <?php // rooms navigation ?>
            <?php if ($gms2_parser->navigation_rooms_content) : ?>
                <div class="resource-tree">
                    <?php echo $gms2_parser->navigation_rooms_content; ?>
                </div>
            <?php endif; ?>
        ...
        <div class="page-scripts-inner">
            ...
            <div class="toggle-notes">
                ...
                <div class="toggle-notes-container">
                    ...
                    <?php prnt($gms2_parser->resources); ?>
                    <?php prnt($gms2_parser->navigation_scripts_array); ?>
                    <?php prnt($gms2_parser->navigation_rooms_array); ?>
                </div>
            </div>
...
return false;
            ...
            <?php if ($resources = $gms2_parser->resources) : ?>
                <?php foreach ($resources as $resource) : ?>
                    <?php $gms2_parser->output_text_file($resource); ?>
                <?php endforeach; ?>
            <?php endif; ?>
